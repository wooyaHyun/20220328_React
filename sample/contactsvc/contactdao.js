        ...
        return new Promise(function(resolve, reject) {
            ...
            db.serialize(function() {
                try {
                    ...
                    console.log('for=>',arr);
                    for (var i = 0; i < arr.contacts.length; i++) {
                        // console.log(arr[0]);
                        console.log(arr.contacts.length)
                        stmt.run(++no, arr.contacts[i].name, arr.contacts[i].tel, arr.contacts[i].address, 'noimage.jpg');
